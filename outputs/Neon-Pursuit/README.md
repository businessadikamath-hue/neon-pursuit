...
**Ultra** is the balanced daily preset: it keeps the close authored geometry, PBR surfaces, animated water, wildlife, reflections and the full biome weather effects while using 1536² shadows, 2× MSAA, 64×48 water tessellation and a reduced near-field population. **Ultra+** adds a dedicated maximum detail tier: sculpted tire tread and brake parts, finer interiors and light optics, cambered nearby leaves and needle bundles, denser ground/shore objects, higher-resolution surface maps, and fitted wildlife face/feather/fur detail. Lower presets retain their simpler geometry and material choices.
