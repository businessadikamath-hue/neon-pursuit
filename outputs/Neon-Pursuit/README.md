...
**Game Only** keeps the road, player, basic traffic and essential signs/signals, with scenery, wildlife, weather, water, environmental reflections and shadows disabled. **Low**, **Medium · most optimized**, **High · rich detail** and **Ultra · maximum** add progressively more detail. The graphics selector supports the mouse wheel.

**High** is the balanced daily preset: it keeps the close authored geometry, premium 4K PBR surface maps, enhanced post shading, animated water, wildlife, reflections and the full biome weather effects while using 1024² shadows, 2× MSAA, 48×32 water tessellation and a reduced near-field population. Dynamic shadow refresh is paced at 24 Hz and tiny road aggregate stays lit by the main pass without entering the shadow map, preserving detail while keeping the frame budget steady. **Ultra** adds a dedicated maximum detail tier: sculpted tire tread and brake parts, finer interiors and light optics, cambered nearby leaves and needle bundles, denser ground/shore objects, higher-resolution surface maps, and fitted wildlife face/feather/fur detail. Lower presets retain their simpler geometry and material choices.
...
High keeps the near-field authored geometry and premium surface maps, but paces dynamic shadow refresh at 24 Hz, omits tiny aggregate from the shadow pass, and uses a tuned post-shading tier so additional material detail does not require the maximum Ultra population costs. When a patrol begins, the alert briefly renders a small live picture-in-picture of the pursuing car for two seconds. It then closes automatically while the regular forward driving view remains available for the rest of the chase.
